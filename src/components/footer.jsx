        ...
        <div className="container-xxl">
          <div className="row justify-content-center justify-content-md-start">
            <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
              ...
              <div className="mb-3">
                <p>
                  <b>Address:</b> Anakapalle, Near Visakhapatnam, 4 Roads
                </p>{" "}
              </div>
              <div className="mb-3">
                <p>
                  <b>Phone:</b>{" "}
                  <a className="footer-tel" href="tel:+91 7702341208">
                    Call us at +91 7702341208
                  </a>
                </p>{" "}
              </div>
              <div className="mb-4">
              ...
              <div className="socials d-flex gap-3">
                ...
                <Link
                  to={"https://github.com/PrasadTirri"}
                  className="gap-3"
                  id="footer-link"
                >
                  <BsGithub />
