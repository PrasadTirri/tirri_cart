            ...
            <div className="col-12 p-5">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-6">
                    <div className="card-body">
                      <h5 className="card-title">Kajal Agarwal</h5>
                      <p className="card-text">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit{" "}
            ...
            <div className="col-12 p-5">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-6">
                    <div className="card-body">
                      <h5 className="card-title">Shopping Ann</h5>
                      <p className="card-text">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit{" "}
                        <br />. Doloribus maxime consequatur, ipsam architecto
                        incidunt volup <br />
            ...
            <div className="col-12 p-5">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-6">
                    <div className="card-body">
                      <h5 className="card-title">Deepthi Agarwal</h5>
                      <p className="card-text">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit{" "}
                        <br />. Doloribus maxime consequatur, ipsam architecto
                        incidunt volup <br />
            ...
            <div className="col-12 p-5">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-6">
                    <div className="card-body">
                      <h5 className="card-title">Shraddha Kapoor</h5>
                      <p className="card-text">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit{" "}
                        <br />. Doloribus maxime consequatur, ipsam architecto
                        incidunt volup <br />
